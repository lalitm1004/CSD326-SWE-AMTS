...
#use-case-table(
  ...
  extensions: [
    ...
    *5a.* «extend» UC8 - Allocate VIP / Comp. Seats: Optionally, the Show Manager allocates VIP and complimentary seats.
  ],
...
// ═══════════════════════════════════════════════════════════════
//  UC8 - Allocate VIP / Complimentary Seats
// ═══════════════════════════════════════════════════════════════
#use-case-table(
  id:              "UC8",
...
#use-case-table(
  ...
  extensions: [
    ...
    *4b.* «extend» UC10 - Purchase Coupon: The spectator optionally applies a coupon for a 10% discount.
  ],
...
#use-case-table(
  ...
  dependency:      "«extend» UC9 - Purchase Ticket Online (coupon is used during online ticket purchase).",
  generalization:  "-",
  main-scenario: [
...
#use-case-table(
  ...
  dependency:      "UC9 - Purchase Ticket Online or UC11 - Purchase via Agent.",
  generalization:  "-",
  main-scenario: [
...
#use-case-table(
  ...
  preconditions:   "The Financial Clerk is logged in. At least one show exists in the system. This use case includes UC13 (View Sales Records) as part of comprehensive financial management.",
  ...
  dependency:      "«include» UC13 - View Sales Records",
  generalization:  "-",
  main-scenario: [
