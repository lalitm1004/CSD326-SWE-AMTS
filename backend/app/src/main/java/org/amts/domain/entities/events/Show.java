package org.amts.domain.entities.events;
...
public class Show {
    ...
    public void setOrdinarySeatPrice(double price) {
        this.ordinarySeatPrice = price;
    }

    public void setBalconySeatPrice(double price) {
        this.balconySeatPrice = price;
    }

    public void setNumOrdinarySeats(int n) {
        this.numOrdinarySeats = n;
    }

    public void setNumBalconySeats(int n) {
        this.numBalconySeats = n;
    }
}
