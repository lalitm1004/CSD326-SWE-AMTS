...
public class Booking {
    ...
    public UUID getSpectatorUserId() { return spectatorUserId; }
    public UUID getSalesAgentId() { return salesAgentId; }
    public LocalDateTime getCreatedAt() { return createdAt; }

    // setters
    public void setSalesAgentId(UUID salesAgentId) { this.salesAgentId = salesAgentId; }
}
